import cv2
from PyQt6.QtWidgets import  QLabel, QPushButton, QVBoxLayout, QFileDialog, QWidget
from PyQt6.QtGui import QPixmap, QImage,QGuiApplication
from PyQt6.QtCore import Qt, QTimer

from utils.write_file import write_file
from utils.getcolor import get_color_name
...
# Function Display camera frame
    ...
    def displayColorInfo(self):
        if self.double_clicked:
            ...
            write_file("./logs/clicked_color.txt", text)
            self.displayImage()
            self.double_clicked = False
